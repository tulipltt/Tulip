...
<g>
	<g>
		...
		<linearGradient id="lg1" gradientUnits="userSpaceOnUse" x1="694.4882" y1="1470.828" x2="694.4882" y2="1025.5583">
			<stop offset="0" style="stop-color:#6317AC"/><stop offset="1" style="stop-color:#6E1BB4"/>
		</linearGradient>
		<rect x="669.07" y="1025.56" style="clip-path:url(#cp1);fill:url(#lg1);" width="50.83" height="445.27"/>
	</g>
	...
	<linearGradient id="lg2" gradientUnits="userSpaceOnUse" x1="365.9499" y1="1241.2678" x2="1023.0265" y2="147.7086">
		<stop offset="0" style="stop-color:#5E17A8"/><stop offset="1" style="stop-color:#C735F7"/>
	</linearGradient>
	<path style="fill:url(#lg2);" d="M1332.28,694.49c0,352.24-285.55,637.8-637.8,637.8s-637.8-285.55-637.8-637.8s285.55-637.8,637.8-637.8S1332.28,342.24,1332.28,694.49z M694.49,108.66c-323.54,0-585.83,262.28-585.83,585.83s262.28,585.83,585.83,585.83s585.83-262.28,585.83-585.83S1018.03,108.66,694.49,108.66z"/>
	<linearGradient id="lg3" gradientUnits="userSpaceOnUse" x1="694.4882" y1="1096.8975" x2="694.4882" y2="249.6056">
		<stop offset="0" style="stop-color:#FF0087"/><stop offset="1" style="stop-color:#F8D82E"/>
	</linearGradient>
	<path style="fill:url(#lg3);" d="M884.47,434.38c41.01,71.05,64.48,153.37,64.48,241.03s-23.47,169.98-64.48,241.03c-42.46,73.55-103.65,134.84-177.02,177.28l-12.84,3.19l-13.08-3.19c-73.37-42.44-134.56-103.72-177.02-177.28c-41.01-71.05-64.48-153.37-64.48-241.03s23.47-169.98,64.48-241.03c42.46-73.55,103.65-134.84,177.02-177.28l12.96-7.5l12.96,7.5C780.81,299.54,842.01,360.83,884.47,434.38 M897.11,675.41c0-78.55-20.89-152.07-57.39-215.31c-35.32-61.19-85.32-112.93-145.23-150.44c-59.9,37.51-109.91,89.24-145.23,150.44c-36.5,63.24-57.39,136.76-57.39,215.31s20.89,152.07,57.39,215.31c35.32,61.19,85.32,112.93,145.23,150.44c59.9-37.51,109.91-89.24,145.23-150.44C876.22,827.48,897.11,753.95,897.11,675.41z"/>
	<g>
		...
		<linearGradient id="lg4" gradientUnits="userSpaceOnUse" x1="987.9117" y1="1174.0785" x2="541.416" y2="297.7812" gradientTransform="matrix(-1 0 0 1 1598.9763 0)">
			<stop offset="0" style="stop-color:#5E17A8"/><stop offset="1" style="stop-color:#C735F7"/>
		</linearGradient>
		<rect x="581.52" y="324.24" style="clip-path:url(#cp2);fill:url(#lg4);" width="531.42" height="772.65"/>
	</g>
	<g>
		...
		<linearGradient id="lg5" gradientUnits="userSpaceOnUse" x1="777.8694" y1="1174.0935" x2="331.4537" y2="297.7679">
			<stop offset="0" style="stop-color:#5E17A8"/><stop offset="1" style="stop-color:#C735F7"/>
		</linearGradient>
		<rect x="276.03" y="324.24" style="clip-path:url(#cp3);fill:url(#lg5);" width="531.42" height="772.65"/>
	</g>
</g>
</svg>"""
    ...
    fun generateHtml(reportData: ReportData): String {
        ...
        out.appendHTML().html {
            ...
            head {
                ...
                style { unsafe { +ReportStyles.grafanaTheme } }
                script { src = "https://www.gstatic.com/charts/loader.js" }
                script { unsafe { +ReportScripts.googleChartsBase } }
            }
            body {
                ...
                div("sidebar") {
                    ...
                    nav {
                        div("nav-group-label") { +"Overview" }
                        a(href = "#overview", classes = "nav-link active") { +"Summary Dashboard" }
                        
                        div("nav-group-label") { +"Benchmarks" }
                        groupedResults.keys.forEach { name ->
                            a(href = "#benchmark_${name.replace(" ", "_")}", classes = "nav-link") { +name }
                        }

                        div("nav-group-label") { +"Configuration" }
                        a(href = "#config", classes = "nav-link") { +"Benchmark Config" }
                        a(href = "#runtime", classes = "nav-link") { +"Tulip Runtime" }
                    }
                }
                ...
                div("main-content") {
                    header {
                        ...
                        div("metadata-section") {
                            ...
                            metricCard("Total Actions", reportData.results.sumOf { it.numActions }.toString())
                            val totalFailed = reportData.results.sumOf { it.numFailed }
                    ...
                    div("dashboard-grid") {
                        id = "overview"
                        statsCard("All Benchmarks Summary", classes = "full-width") {
                            summaryTable(groupedResults)
                        }

                        val maxRows = groupedResults.values.maxOfOrNull { it.size } ?: 0

                        statsCard("Throughput Comparison (All Actions)", classes = "full-width", isChart = true) {
                                ...
                                val dataRows = (0 until maxRows).map { rowIdx ->
                                    ...
                                    groupedResults.forEach { (bmName, results) ->
                                        ...
                                        actionNames.forEach { actionName ->
                                            ...
                                            val errAps = if (actionStats != null && res.duration > 0) actionStats.numFailed / res.duration else 0.0
                                ...
                                unsafe {
                                    +"""
                                        google.charts.setOnLoadCallback(function() {
                                            drawCombinedTimeSeriesChart('chart_combined_aps', [$labels], [$dataRows], 'Throughput per Action (All Benchmarks)', 'APS');
                                        });
                                    """.trimIndent()
                                }
                            }
                        ...
                        statsCard("Latency Comparison (All Actions)", classes = "full-width", isChart = true) {
                            ...
                            script {
                                ...
                                unsafe {
                                    +"""
                                        google.charts.setOnLoadCallback(function() {
                                            drawCombinedTimeSeriesChart('chart_combined_rt', [$labels], [$dataRows], 'Average Latency per Action (All Benchmarks)', 'ms');
                                        });
                                    """.trimIndent()
                                }
                            }
                        ...
                        statsCard("Latency Distribution Comparison (All Actions)", classes = "full-width", isChart = true) {
                            ...
                            script {
                                ...
                                unsafe {
                                    +"""
                                        google.charts.setOnLoadCallback(function() {
                                            drawCombinedPercentileChart('chart_combined_dist', [$labels], [$dataRows], 'Tail Latency Comparison (All Actions)', 'ms');
                                        });
                                    """.trimIndent()
                                }
                            }
                    ...
                    groupedResults.forEach { (bmName, results) ->
                        ...
                        div("dashboard-grid") {
                            statsCard("Action Results", classes = "full-width") {
                                detailedBenchmarkTable(results)
                            }

                            val allActions = results.flatMap { it.userActions.values.map { a -> a.name } }.distinct().sorted()

                            statsCard("Latency Distribution per Action", classes = "full-width", isChart = true) {
                                ...
                                script {
                                    ...
                                    unsafe {
                                        +"""
                                            google.charts.setOnLoadCallback(function() {
                                                drawCombinedPercentileChart('chart_dist_$bmId', [$labels], [$dataPoints], 'Tail Latency per Action (ms)', 'ms');
                                            });
                                        """.trimIndent()
                                    }
                                }
                            ...
                            statsCard("Throughput (APS) per Action", classes = "full-width", isChart = true) {
                                ...
                                script {
                                    ...
                                    unsafe {
                                        +"""
                                            google.charts.setOnLoadCallback(function() {
                                                drawCombinedTimeSeriesChart('chart_aps_$bmId', [$labels], [$dataRows], 'Throughput per Action', 'APS');
                                            });
                                        """.trimIndent()
                                    }
                                }
                            ...
                            statsCard("Average Latency per Action", classes = "full-width", isChart = true) {
                                ...
                                script {
                                    ...
                                    unsafe {
                                        +"""
                                            google.charts.setOnLoadCallback(function() {
                                                drawCombinedTimeSeriesChart('chart_rt_$bmId', [$labels], [$dataRows], 'Avg Latency per Action (ms)', 'ms');
                                            });
                                        """.trimIndent()
                                    }
                                }
